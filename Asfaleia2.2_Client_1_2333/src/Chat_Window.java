...
public class Chat_Window extends javax.swing.JFrame {
    ...
    public static ArrayList <ArrayList <User>> Ports;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Welcome Stathis");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        for (int i = 0; i < Ports.size(); i++) {
            ...
            try {
                ...
                ObjectOutputStream OUT = new ObjectOutputStream(new Socket("127.0.0.1", parseInt(Ports.get(i).get(i).getPort())).getOutputStream());
                OUT.writeObject(mes);
                OUT.flush();
